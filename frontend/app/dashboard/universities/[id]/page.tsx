            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex justify-between items-center pt-8 border-t border-slate-200/50">
                <div className="flex space-x-3">
                  ...
                  <Link
                    href={`/dashboard/universities/${id}/settings`}
                    className="px-6 py-3 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-sm font-bold shadow-lg hover:shadow-xl transition-all flex items-center space-x-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
