      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="glass-card rounded-3xl p-8 border border-white/50 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 font-medium">CMSにアクセスするにはログインしてください</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200/50">
            ...
            <div className="mt-2 space-y-1 text-xs text-slate-600">
              ...
              <p><strong>編集者:</strong> editor@example.com / password</p>
              <p><strong>ユーザー:</strong> author@example.com / password</p>
            </div>
          </div>
        </div>
      </div>
