...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-white/80 backdrop-blur-xl border-r border-slate-200/50 min-h-screen sticky top-0">
      <div className="p-6">
        <h2 className="text-lg font-bold text-slate-800 mb-4">管理メニュー</h2>
